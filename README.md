...
- **✨ Dashboard upgrades** — a "Sequences" sidebar item, a supercharged campaign modal (variable chips + live preview), native Hebrew fixes, and campaign delivery analytics, using Chatwoot's original light and dark appearance
...
Adds a "Sequences" item to the main sidebar, upgrades Chatwoot's native WhatsApp campaign modal with variable chips and a live message preview, fills reusable template media automatically, fixes missing native Hebrew strings, and adds campaign delivery analytics. The dashboard keeps Chatwoot's original light and dark appearance. Only narrow RTL and mobile usability fixes supplement its native styles.
...
| Dashboard Enhancements | `dashboard` | Campaign modal upgrade, reusable template media, native Hebrew fixes, campaign analytics and narrow native UI fixes |
