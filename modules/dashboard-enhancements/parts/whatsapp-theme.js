...
(function () {
  ...
  var CSS = [
    ...
    '#app .conversations-list-wrap ul.list-none>li>:is(a,button).text-button>:is(div,span){background:transparent;color:inherit;padding:0;min-width:0;height:auto;margin-inline-start:4px;font-weight:500}',
