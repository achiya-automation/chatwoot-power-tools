...
test('canSend: a saturated contact (repeated 131049) is DEFERRED, never dropped', () => {
  // תוקן 2026-07-13. הכלל הישן היה 'drop', והוא מחק 335 הרשמות בפרודקשן — 324 מהן על
...
// ═══════════════════════════════════════════════════════════════════════════
// 2026-07-13 — מה שהנתונים לימדו אותנו (פרודקשן, n=4,998)
// ═══════════════════════════════════════════════════════════════════════════

test('canSend: רוויה (131049) נדחית ולא מסירה — התקרה של מטא זמנית, opt-out לא', () => {
  // 324 מתוך 335 ההרשמות שנפלו בפרודקשן נפלו על 131049 — שגיאה זמנית. הן נמחקו מהרצף
