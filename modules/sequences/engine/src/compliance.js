...
export const DEFAULT_SETTINGS = Object.freeze({
  ...
  // אבל שלב שה-next_send_at שלו רחוק מפספס אותו (נמדד: 48% מהחלונות התבזבזו).
  // כשהדגל דולק, reconcile מקדים את השלב הבא אל תוך החלון — שלב אחד לכל חלון,
  // אותה תבנית ואותו סדר; רק התזמון זז. כבוי כברירת מחדל: שינוי קצב-שליחה מוחלט
  // רק בהסכמה מפורשת של בעל החשבון.
