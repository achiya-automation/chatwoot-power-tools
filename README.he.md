...
חסרים בממשק המקורי ומוסיף אנליטיקת מסירה לקמפיינים. הדשבורד והתוספים שומרים על העיצוב
המקורי של Chatwoot במצב בהיר וכהה, עם תיקוני שימושיות נקודתיים לעברית ולמובייל.
...
| שדרוגי דשבורד | `dashboard` | שדרוג מודאל הקמפיין, מדיה חוזרת לתבניות, תיקוני עברית, אנליטיקת קמפיינים ותיקוני שימושיות נקודתיים |
